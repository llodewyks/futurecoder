...
ARG NODE_MAJOR=22
ARG REACT_APP_PROGRESS_API_BASE=""
ARG REACT_APP_PROGRESS_API_KEY=""
...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    CI=false \
    REACT_APP_PROGRESS_API_BASE=${REACT_APP_PROGRESS_API_BASE} \
    REACT_APP_PROGRESS_API_KEY=${REACT_APP_PROGRESS_API_KEY} \
